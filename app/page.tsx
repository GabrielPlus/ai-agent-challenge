...
const features = [
  {
    title: "AI analysis",
    description:
      "Get deep insights into your video content with Corrina AI. Understund viewer engagment and content quality.",
    icon: Brain,
    iconBg: "bg-blue-100",
...
export default function Home() {
  return (
    <div className="min-h-screen">
              ...
              return (
                ...
                >
                  <div
                    ...
                    justify-center mb-4 ${feature.iconBg}`}
                  >
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600
                    to-blue-400 rounded-full flex items-center justify-center
                    mx-auto mb-4">
      ...
      <section className="py-20 px-4 md:px-0 bg-gradient-to-r from-blue-600
                to-blue-400">
